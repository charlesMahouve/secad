"""
Django settings for secad project.
...
SECRET_KEY = 'django-insecure-(bd&$d3si7q=hjd%*g61!fp(o+p)&vmi7#!%xg!34-q4(5^%2q'
...
WSGI_APPLICATION = 'secad.wsgi.application'
